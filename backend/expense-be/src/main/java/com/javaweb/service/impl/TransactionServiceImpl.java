...
public class TransactionServiceImpl implements TransactionService {
    ...
    public TransactionResponseDTO createTransaction(TransactionRequestDTO transactionRequest) {
        ...
        WalletEntity wallet = walletRepository.findById(transactionRequest.getWalletId())
        ...
        transactionEntity.setWalletTransaction(wallet);
        ...
        return transactionRepository.findById(id)
                .map(transaction -> {
                    ...
                    if (transactionRequest.getWalletId() != null) {
                        WalletEntity wallet = walletRepository.findById(transactionRequest.getWalletId())
                                .orElseThrow(() -> new RuntimeException("Wallet not found"));
                        transaction.setWalletTransaction(wallet);
                    }
